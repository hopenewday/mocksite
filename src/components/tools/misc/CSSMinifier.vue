...
.input-brutal { @apply w-full p-3 border-4 border-black bg-white text-black; }
.dark .input-brutal { background-color: #000000; color: #ffffff; }
.btn-primary { @apply px-4 py-2 border-4 border-black font-black; box-shadow: 4px 4px 0px 0px #000000; }
.btn-primary-yellow { background-color: #facc15; }
.btn-primary-lime { background-color: #a3e635; }
.btn-primary-pink { background-color: #f472b6; }
.btn-primary-white { @apply bg-white; }
.card-brutal-white { background-color: #ffffff; }
.card-brutal-black { background-color: #000000; }
</style>
