    ...
    <div class="grid md:grid-cols-3 gap-6 mb-8">
      ...
      <div class="bg-brutal-white dark:bg-brutal-black border-4 border-black dark:border-brutal-white p-6 space-y-4">
        ...
        <div class="grid grid-cols-2 gap-2 mt-4">
          <button
            class="btn-primary btn-primary-cyan text-xs"
      ...
      <div class="md:col-span-2">
        ...
        >
          <div
            class="w-full h-full bg-brutal-cyan dark:bg-brutal-black border-4 border-black dark:border-brutal-white p-8 cursor-pointer flex items-center justify-center"
          ...
          >
            ...
            >
              <div
                ...
                class="text-center"
              >
                <div class="text-sm font-bold text-brutal-gray mb-4">
                  Question
                </div>
                <div class="text-2xl font-black break-words">
                  {{ currentCard?.front }}
                </div>
                <div class="text-xs text-brutal-gray mt-4">
        ...
        >
          ...
          >
            ...
            <div class="text-sm font-bold text-brutal-gray mb-3">
              {{ card.back }}
            </div>
            <button
          ...
          <div
            v-if="cards.length === 0"
            class="text-center py-8 font-bold text-brutal-gray"
          >
